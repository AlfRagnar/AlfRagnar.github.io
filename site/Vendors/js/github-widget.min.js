...
(function () {
  ...
  t = function (c, b) {
    ...
    h({ cls: 'gw-clearer', prevSib: b });
    a = b.getAttribute('data-user');
    d = b.getAttribute('data-options');
    ...
    for (f = r.length; a < f; a++)
      if (
        ...
        !(
          (!d.forks && l.fork) ||
          ((n = l.name.toLowerCase()), 0 <= v.call(p, n))
        ) && l.description)
      ) {
        if (e++ === g) break;
        k.push(
            ...
            kids: [
              h({
                ...
                kids: [
                    ...
                    kids: [
                      h({
                        ...
                        kids: [
                          ...
                          h({ tag: 'li', text: l.forks, cls: 'gw-forks' }),
                        ],
                      }),
                      h({
                        tag: 'a',
                  ...
                  null != l.language
                    ? h({ cls: 'gw-lang', text: l.language })
                    : void 0,
                  h({ cls: 'gw-repo-desc', text: l.description }),
                ],
              }),
            ],
          })
  ...
  p = function (c, b) {
    ...
    if (null != g) {
      d = 0;
      for (e = g.length; d < e; d++) if (((a = g[d]), !f[a])) return !1;
      return !0;
    }
    return null;
  };
  ...
  m = function (c) {
    ...
    if ((b = null != c.cls) && '*' === f && null != a.getElementsByClassName)
      return a.getElementsByClassName(c.cls);
    ...
    if (b) {
      ...
      for (h = a.length; d < h; d++)
        (b = a[d]), p(b, { has: c.cls }) && k.push(b);
      a = k;
    }
    return null == c.multi &&
      ((g = f.toLowerCase()), 0 <= v.call(m.uniqueTags, g))
      ? null != (e = a[0])
        ? e
        : null
      : a;
  ...
  n = function (c) {
    var b, a, f;
    b = null != (a = c.callback) ? a : '_JSONPCallback_' + n.callbackNum++;
    a = c.url.replace('<cb>', b);
    window[b] = null != (f = c.success) ? f : n.noop;
    return h({ tag: 'script', src: a, parent: m({ tag: 'head' }) });
  };
  n.callbackNum = 0;
  n.noop = function () {};
  (function () {
    var c, b, a, f, g, e;
    g = m({ tag: 'div', cls: 'github-widget' });
    e = [];
    b = a = 0;
    for (f = g.length; a < f; b = ++a)
      (c = g[b]),
        e.push(
          (function (a, b) {
            k.push([]);
